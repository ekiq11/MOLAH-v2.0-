...
class AyahShareFullScreenPage extends StatefulWidget {
  ...
  const AyahShareFullScreenPage({
    ...
    String? ayahTextWithHarokat,
  });

  @override
  State<AyahShareFullScreenPage> createState() =>
      _AyahShareFullScreenPageState();
}
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 12),
                Expanded(child: Text('Gagal membagikan ayat: ${e.toString()}')),
              ],
            ),
                          ...
                          if (displayMode == 0 || displayMode == 1)
                            Flexible(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontFamily: 'Utsmani',
                                  fontSize: displayMode == 1
                                      ? 28
                                      : 24, // Lebih besar jika solo
                                  height: 1.9,
                                  color: Colors.white,
                          ...
                          if (displayMode == 0 || displayMode == 2)
                            Flexible(
                              child: Text(
                                ...
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: displayMode == 2
                                      ? 16
                                      : 14, // Lebih besar jika solo
                                  height: 1.7,
                                  color: Colors.white,
                                  fontWeight: FontWeight.w500,
                                  letterSpacing: 0.2,
